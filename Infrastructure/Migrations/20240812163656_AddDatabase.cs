...
namespace Infrastructure.Migrations
{
    ...
    constraints: table =>
    {
        ...
        table.ForeignKey(
            ...
            principalTable: "Categories",
            principalColumn: "Id",
            onDelete: ReferentialAction.Cascade); // Keep this as CASCADE if needed
        table.ForeignKey(
            name: "FK_Car_SubCategories_SubCategoryId",
            column: x => x.SubCategoryId,
            principalTable: "SubCategories",
            principalColumn: "Id",
            onDelete: ReferentialAction.Restrict); // Change to Restrict to prevent cascade deletion
    });
            //migrationBuilder.CreateTable(
            //    name: "Car",
            //    columns: table => new
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LogCar", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LogCar_Car_CarsId",
                        column: x => x.CarsId,
                        principalTable: "Car",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Car_SubCategoryId",
                table: "Car",
                column: "SubCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_LogCar_CarsId",
                table: "LogCar",
                column: "CarsId");
